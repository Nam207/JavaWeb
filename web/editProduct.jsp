                    ...
                    <div class="modal-content">
                        <form action="UpdateControl" method="post">
                            ...
                            <div class="modal-body">	
                                ...
                                <div class="form-group">
                                    <label>Amount</label>
                                    <input value="${detail.amount}" name="amount" type="number" class="form-control" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="gender" class="form-select" aria-label="Default select example">
                                        <option selected="${detail.gender==true?"selected":""}" value="1">Male</option>
                                        <option selected="${detail.gender==false?"selected":""}" value="0">Female</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="category" class="form-select" aria-label="Default select example">
                                        <c:forEach items="${cate}" var="o">
                                            <option selected="${detail.catID==o.key?"selected":""}" value="${o.key}">${o.value.name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="title" class="form-select" aria-label="Default select example">
                                        <c:forEach items="${listTitle}" var="o">
                                            <option selected="${detail.title==o?"selected":""}" value="${o}">${o}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="size" class="form-select" aria-label="Default select example">
                                        <c:forEach items="${listSize}" var="o">
                                            <option selected="${detail.size==o?"selected":""}" value="${o}">${o}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="color" class="form-select" aria-label="Default select example">
                                        <c:forEach items="${listColor}" var="o">
                                            <option selected="${detail.color==o?"selected":""}" value="${o}">${o}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
