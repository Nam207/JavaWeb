...
public class CategoryControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql="Select * from HE141488_product Where";
        String sql2="Select count(*) from HE141488_product Where";
        int count=0;
        if(title!=null){
            if(count!=0) sql+=" and";
            sql+=" title = '"+title+"'";
        ...
        if(index!=null){
            ...
            if(count==0){
                sql="Select * from HE141488_product ORDER BY id OFFSET "+indexPage+" ROWS FETCH NEXT 6 ROWS ONLY";
                sql2="Select count(*) from HE141488_product";
            }else{
