...
public class HistoryControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        List<String> listTime= dao.loadTime(a.getId()+"");
        List<checkOut> listOut= dao.loadCheckOut(a.getId()+"");
        HashMap<Integer,product> listPro= dao.getProductList("Select * from HE141488_product");
